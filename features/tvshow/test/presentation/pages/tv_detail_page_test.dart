...
void main() {
  ...
  group('detail test', () {
    testWidgets('content of Tv Details and recommendation should display',
        (WidgetTester tester) async {
      when(() => mockTvDetailBloc.state)
          .thenReturn(TvDetailSuccess(testTvDetail));
    ...
    testWidgets('should display text with message when Error getting detail',
        (WidgetTester tester) async {
      when(() => mockTvDetailBloc.state).thenReturn(TvError('Error message'));
