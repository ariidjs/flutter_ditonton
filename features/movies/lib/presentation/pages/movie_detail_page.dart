        ...
        builder: (context, state) {
          if (state is MovieLoading) {
            ...
            final movieRecommendations =
                context.select<MovieRecommentaionsBloc, List<Movie>>((value) {
              final recommendationState = value.state;
              return recommendationState is MovieSuccess
                  ? recommendationState.movieList
                  : [];
            });
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                if (state is MovieWatchlistStatus ||
                                    state is WatchlistMovieMessage) {
                            ...
                            BlocBuilder<MovieRecommentaionsBloc, MovieState>(
                              builder: (context, state) {
                                if (state is MovieLoading) {
                                  ...
                                  return SizedBox(
                                    key: const Key('recommendation-test'),
                                    height: 150,
